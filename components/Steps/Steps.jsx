  ...
  return (
    <div className={`${containerStyles.container} ${styles["steps-page"]}`}>
      ...
      <div itemScope itemType="http://schema.org/HowTo">
        <h2 itemProp="name" className={containerStyles.container__title} id="steps">
        ...
        <ul className={styles.steps}>
          ...
          >
            ...
            <p itemProp="name" className={styles.steps__description}>
...
125 -10 237 31 328 121 221 222 127 593 -173 686 -79 24 -160 25 -233 1z"
      ...
      <VisibilityManager as="div">
        <h2 className={containerStyles.container__title} id="ways">
      ...
      <ul className={styles["steps-rows"]}>
        ...
        >
          ...
          <p
            className={`${styles["steps-rows__item-description"]} ${styles["steps-rows__item-description--white"]}`}
          >
            {` 
          ...
          <p className={styles["steps-rows__item-description"]}>
...
В любое время у вас есть возможность отказаться от полученного сертификата и выбрать другие способы получения протеза.`}
        ...
        >
          ...
          <p className={styles["steps-rows__item-description"]}>
            {`Необходимые документы: ИПРА, Паспорт РФ (свидетельство о рождении ребенка), СНИЛС, Документы, подтверждающие расходы, Паспорт изделия, Копия сертификата соответствия.
