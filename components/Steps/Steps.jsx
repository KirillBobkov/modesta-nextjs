...
export function Steps() {
  return (
    <div
      className="max-w-7xl w-full mx-auto px-4 md:px-10 mb-16 md:mb-32"
    >
      <h2
        className="text-left md:text-center text-2xl md:text-5xl leading-8 md:leading-[60px] mb-5 md:mb-8 font-bold whitespace-pre-line uppercase max-w-sm md:max-w-none mx-auto md:mx-0"
        id="support"
      >
        Бесплатная поддержка при получении современного протеза руки!
      </h2>
      <p
        className="w-full lg:w-1/2 mx-auto text-center text-secondary-font-color mb-10 whitespace-pre-line"
      >
        Мы обеспечиваем помощь в оформлении документов для протезирования,
        решаем сложности с медико-социальной экспертизой, сопровождаем получение
        ИПРА по государственной программе - безвозмездно
      </p>
      <div itemScope itemType="http://schema.org/HowTo">
        ...
        <ul
          className="flex justify-center items-stretch flex-wrap gap-y-10 mt-16 mb-24 lg:gap-x-[2%]"
        >
          <VisibilityManager
            as="li"
            itemProp="step"
            ...
            className="relative py-10 px-5 bg-card-bg-color rounded-[30px] w-full flex flex-col justify-center items-center gap-5 shadow-[0_6px_20px_0px_rgba(0,0,0,0.20)] lg:p-5 lg:pt-8 lg:w-[32%] lg:min-h-[300px]"
          >
            <meta itemProp="position" content="1" />
            <div
              className="absolute -top-5 left-1/2 -translate-x-1/2 w-10 h-10 flex items-center justify-center rounded-full bg-accent font-bold text-black"
            >
              1
            </div>
            <p
              itemProp="name"
              className="text-center w-full text-secondary-font-color whitespace-pre-line"
            >
              Консультация специалиста-инженера по протезированию для выбора
              подходящего протеза
            </p>
            <svg
              id="Layer_1"
          ...
          >
            ...
            <p
              ...
              className="text-center w-full text-secondary-font-color whitespace-pre-line"
            >
              Получение медико-технического заключения (МТЗ) с рекомендацией
              использования протеза и сопровождение процедур медико-социальной
              экспертизы
            </p>
            <svg
              version="1.0"
            ...
            >
              ...
              >
                <path
                  d="M5450 11879 c-459 -52 -892 -262 -1217 -591 -180 -181 -290 -337
...
-29 1213 -405 1684 -341 427 -840 701 -1382 760 -112 13 -338 12 -448 0z"
                />
                <path
                  d="M4285 7773 c-22 -9 -87 -34 -143 -56 l-104 -39 -132 -132 c-336 -333
...
180 0 180 0 0 -210z"
                />
                <path
                  d="M8140 5981 c-142 -46 -234 -134 -279 -269 -84 -247 95 -517 357 -539
125 -10 237 31 328 121 221 222 127 593 -173 686 -79 24 -160 25 -233 1z"
          ...
          >
            ...
            <p
              ...
              className="text-center w-full text-secondary-font-color whitespace-pre-line"
            >
              Создание индивидуальной программы реабилитации (ИПРА) с учетом
              необходимого технического средства
            </p>
            <svg
              version="1.1"
              id="Layer_1"
            ...
            >
              ...
              <g>
                <g>
                  <path
                    d="M503.962,209.479l-49.347-50.651l-0.379-2.368c-2.001-14.624-15.147-25.262-30.018-23.984
			...
			C510.198,220.206,508.209,213.838,503.962,209.479z"
              ...
              <g>
                <g>
                  <path
                    d="M260.378,464.199h-16.255V322.625h-0.001c0-25.368-16.037-47.053-38.502-55.471c-10.864,11.074-27.549,14.2-41.71,7.335
          ...
          >
            ...
            <p
              ...
              className="text-center w-full text-secondary-font-color whitespace-pre-line"
            >
              Поиск финансирования через благотворительные фонды,
              государственные контракты или беспроцентные займы для изготовления
              протеза
            </p>
            <svg
              version="1.1"
            ...
            >
              <g>
                <g>
                  <g>
                    <path
                      d="M282.844,205.771c-1.772,1.405-3.643,2.545-5.53,3.477h17.899c7.112-8.297,7.237-17.608,1.999-24.223
				...
				c5.816,7.347,14.344,6.761,24.614,3.069c7.099-2.552,10.964-2.652,13.24,0.218C288.799,198.349,287.166,202.35,282.844,205.771z"
                    />
                    <path
                      d="M141.658,209.25L316.091,71.089l20.593-16.317c3.318-2.624,8.131-2.063,10.76,1.252l16.274,20.547l56.049,70.766
				...
				c-6.287-7.928-17.905-9.275-25.843-2.995L124.368,209.25H141.658z"
                    />
                    <path
                      d="M346.542,209.25l48.794-38.653c-7.772-13.056-5.837-29.78,4.692-40.742c0.013-0.008,0.013-0.008,0.018-0.018
				...
				c19.94-15.793,51.341-9.365,70.126,14.351c11.853,14.958,15.834,33.208,12.18,48.62H346.542z"
                    />
                    <path
                      d="M466.934,336.889c-1.213-1.201-2.79-1.807-4.37-1.807h-86.4c-7.892,0-15.787,3.013-21.814,9.037
				...
				S384.755,381.494,376.164,381.494z"
                    />
                    <path
                      d="M347.07,395.029c-7.767-7.772-12.052-18.099-12.052-29.089c0-10.993,4.285-21.322,12.052-29.099
				...
				c0-1.695,1.382-3.085,3.082-3.085h14.4C382.49,482.169,383.88,483.559,383.88,485.254z"
                    />
                    <path
                      d="M421.328,183.171l-19.492,15.447h25.761v-0.681c0-5.266-2.01-10.532-6.026-14.551
				C421.496,183.309,421.412,183.248,421.328,183.171z"
                    />
                    <path
                      d="M164.713,164.186l12.324-9.764c0.054-0.138,0.087-0.256,0.148-0.399c2.744-6.397,6.533-9.608,8.499-11.492l-8.927-6.881
				...
				C164.593,159.074,164.447,161.736,164.713,164.186z"
                    />
                    <path
                      d="M103.66,209.25l72.765-169.743l10.353-24.148c1.669-3.883,6.177-5.686,10.061-4.017l24.1,10.324L301.2,56.08l9.357-7.414
				c-0.768-0.481-1.572-0.929-2.429-1.293L201.068,1.483c-9.298-3.991-20.165,0.358-24.159,9.651L91.994,209.25H103.66z"
                    />
                    <path
                      d="M278.226,51.231l-59.392-25.457c-7.777,13.056-23.414,19.308-38.06,15.268L109.11,208.218l37.322-29.558
          ...
          >
            ...
            <p
              ...
              className="text-center w-full text-secondary-font-color whitespace-pre-line"
            >
              Процесс протезирования на базе специализированных предприятий в
              вашем регионе
            </p>
            <svg
              width="100px"
          ...
          >
            ...
            <p
              ...
              className="text-center w-full text-secondary-font-color whitespace-pre-line"
            >
              Возможность компенсации средств за протезирование со стороны Фонда
            ...
            <svg
              ...
              className="fill-font-color"
            >
              <path d="M6,25.16H6A82.62,82.62,0,0,0,7.12,38.75l.26,1.57a17.4,17.4,0,0,0,2.69,6.79l4.71,7.07a5,5,0,0,1,.68,4A1.51,1.51,0,0,0,16.93,60h6.55A4.52,4.52,0,0,0,28,55.48V47.93a16.64,16.64,0,0,0-2.09-8.08,15.5,15.5,0,0,0-6.69-6.24L16.3,32.15a1.42,1.42,0,0,0-.63-.15h-.25a1.42,1.42,0,0,0-1,2.41l5.18,5.21a1.42,1.42,0,0,1,.08,1.9,1.4,1.4,0,0,1-2.1.06l-3.85-3.85a10.35,10.35,0,0,1-2.5-4l-3-8.89A1.16,1.16,0,0,0,6,25.16Z" />
              <path d="M56.61,40.32l.26-1.57A82.62,82.62,0,0,0,58,25.16h0a1.16,1.16,0,0,0-2.26-.37l-3,8.89a10.35,10.35,0,0,1-2.5,4l-3.85,3.85a1.4,1.4,0,0,1-2.1-.06,1.42,1.42,0,0,1,.08-1.9l5.18-5.21a1.42,1.42,0,0,0-1-2.41h-.25a1.42,1.42,0,0,0-.63.15l-2.92,1.46a15.5,15.5,0,0,0-6.69,6.24A16.64,16.64,0,0,0,36,47.93v8A4.11,4.11,0,0,0,40.11,60h7a1.51,1.51,0,0,0,1.46-1.87,5,5,0,0,1,.68-4l4.71-7.07A17.4,17.4,0,0,0,56.61,40.32Z" />
              <path d="M44,18.35V8.54h0a1,1,0,0,0-.72-1L32.85,4.13A2.74,2.74,0,0,0,32,4h0a2.74,2.74,0,0,0-.85.13L20.69,7.55a1,1,0,0,0-.72,1v9.81A13.95,13.95,0,0,0,31.06,32a4.62,4.62,0,0,0,.94.1h0a4.62,4.62,0,0,0,.94-.1A13.94,13.94,0,0,0,44,18.35Zm-4,0a10,10,0,0,1-7.9,9.72H32V18H24V10.68l8-2.62V18h8Z" />
            </svg>
          </VisibilityManager>
        </ul>
      </div>
      ...
      <VisibilityManager as="div">
        <h2
          ...
          id="ways"
        >
          Воспользуйтесь возможностью получить протез бесплатно
        </h2>
        <p
          className="w-full lg:w-1/2 mx-auto text-center text-secondary-font-color mb-10 whitespace-pre-line [&>a]:underline [&>a]:cursor-pointer"
        >
          Согласно{" "}
          <a target="_blank" href="https://mintrud.gov.ru/docs/government/183">
            Постановлению Правительства РФ от 7 апреля 2008 года № 240
          </a>
          , все граждане с инвалидностью имеют право на бесплатное
          протезирование в рамках индивидуальной программы реабилитации (ИПРА).
        </p>
        <p
          className="w-full lg:w-1/2 mx-auto text-center text-secondary-font-color mb-10 whitespace-pre-line"
        >
          Доступны три способа получения технических средств реабилитации (ТСР)
          за счет средств из федерального бюджета:
        </p>
      </VisibilityManager>

      <ul className="flex justify-center items-stretch flex-wrap gap-10">
        <VisibilityManager
          as="li"
          className="relative p-5 pt-8 bg-card-bg-color rounded-[30px] w-full flex flex-col justify-start items-center gap-5 shadow-[0_6px_20px_0px_rgba(0,0,0,0.20)] lg:w-[45%]"
        >
          <div
            className="absolute -top-5 left-1/2 -translate-x-1/2 w-10 h-10 flex items-center justify-center rounded-full bg-accent font-bold text-black"
          >
          ...
          <h3
            className="text-2xl font-bold text-center w-full text-secondary-font-color whitespace-pre-line"
          >
            Государственный контракт
          </h3>
          <p
            className="text-left w-full text-font-color whitespace-pre-line"
          >
            {` 
          ...
          <p
            className="text-left w-full text-secondary-font-color whitespace-pre-line"
          >
            {` Для получения протеза по государственному контракту требуется предоставить следующие документы: ИПРА, Паспорт РФ (свидетельство о рождении), СНИЛС.
        ...
        >
          ...
          <p
            className="text-left w-full text-secondary-font-color whitespace-pre-line"
          >
            {` Для получения протеза посредством электронного сертификата потребуются следующие документы: паспорт РФ (свидетельство о рождении ребенка), ИПРА и карта МИР.
