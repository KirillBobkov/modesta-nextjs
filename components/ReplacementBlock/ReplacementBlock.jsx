    ...
    return (
        <VisibilityManager classes={`${containerStyles.container} ${containerStyles['container--full-width']} ${styles['replacement-parts__container']}`}>
            <div className={styles['replacement-parts']} id="replacement-parts">
                ...
                >
                <Image className={styles['replacement-parts__item']} width={0} height={0} sizes="100vw" style={{ width: '80%', height: 'auto' }} src={isMobile ? replacementPart1_mobile : replacementPart1} alt="Вариант протеза с расцветкой №1" />
                <Image className={styles['replacement-parts__item']} width={0} height={0} sizes="100vw" style={{ width: '80%', height: 'auto' }} src={isMobile ? replacementPart2_mobile : replacementPart2} alt="Вариант протеза с расцветкой №2" />
                <Image className={styles['replacement-parts__item']} width={0} height={0} sizes="100vw" style={{ width: '80%', height: 'auto' }} src={isMobile ? replacementPart3_mobile : replacementPart3} alt="Вариант протеза с расцветкой №3" />
                <Image className={styles['replacement-parts__item']} width={0} height={0} sizes="100vw" style={{ width: '80%', height: 'auto' }} src={isMobile ? replacementPart4_mobile : replacementPart4} alt="Вариант протеза с расцветкой №4" />
                <Image className={styles['replacement-parts__item']} width={0} height={0} sizes="100vw" style={{ width: '80%', height: 'auto' }} src={isMobile ? replacementPart5_mobile : replacementPart5} alt="Вариант протеза с расцветкой №5" />
                </Carousel>
            </div>
        </VisibilityManager>
    );
