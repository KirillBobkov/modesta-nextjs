    ...
    return (
        <VisibilityManager classes={`${containerStyles.container} ${containerStyles['container--full-width']} ${styles['replacement-parts__container']}`}>
            <div className={styles['replacement-parts']} id="replacement-parts">
                ...
                >
                {isMobile !== undefined && <Image priority className={styles['replacement-parts__item']} src={isMobile ? replacementPart1_mobile : replacementPart1} alt="Вариант протеза с расцветкой №1" />}
                {isMobile !== undefined && <Image priority className={styles['replacement-parts__item']} src={isMobile ? replacementPart2_mobile : replacementPart2} alt="Вариант протеза с расцветкой №2" />}
                {isMobile !== undefined && <Image priority className={styles['replacement-parts__item']} src={isMobile ? replacementPart3_mobile : replacementPart3} alt="Вариант протеза с расцветкой №3" />}
                {isMobile !== undefined && <Image priority className={styles['replacement-parts__item']} src={isMobile ? replacementPart4_mobile : replacementPart4} alt="Вариант протеза с расцветкой №4" />}
                {isMobile !== undefined && <Image priority className={styles['replacement-parts__item']} src={isMobile ? replacementPart5_mobile : replacementPart5} alt="Вариант протеза с расцветкой №5" />}
                </Carousel>
            </div>
        </VisibilityManager>
    );
