...
export default React.memo(() => {
  return (
    <footer itemScope itemType="http://schema.org/WPFooter">
      ...
      <div itemScope itemType="http://schema.org/Organization" className={`${containerStyles.container} ${styles.footer}`}>
        ...
        <div className={styles.footer__grid}>
          ...
          <div className={styles.footer__block}>
            ...
            <div itemProp="address" itemScope itemType="https://schema.org/PostalAddress">
              <p className={styles.footer__address}>ООО "МОДЕСТА" (ОГРН 1234500001603)</p>
          ...
          <div className={`${styles.footer__block} ${styles["footer__block--flex"]}`}>
            ...
            <div className={styles.footer__smi}>
              ...
              >
                <Image alt="Логотип Сколково" src={iconSK} loading="lazy" className={styles.footerimgSK} />
              </a>
              <a target="_blank" href="https://45.ru/text/health/2023/01/27/71984777/">
                <Image alt="45ru логотип" src={icon45ru} loading="lazy" className={styles["footer__smi-link"]} />
              </a>
          ...
          <div className={styles.footer__block}>
            ...
            <div className={styles['footer__social-svg']}>
              <a itemProp="sameAs" target="_blank" href="https://vk.com/modestatech">
                <svg width="45" height="45" xmlns="http://www.w3.org/2000/svg" viewBox="4 4 40 40">
                  {" "}
              ...
              <a itemProp="sameAs" target="_blank" href="https://t.me/modestatech">
                <svg width="45" height="45" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="4 4 40 40">
                  {" "}
              ...
              <a itemProp="sameAs" target="_blank" href="https://ok.ru/group/70000004855153">
                <svg width="45" height="45" xmlns="http://www.w3.org/2000/svg" viewBox="4 4 88 88">
                  {" "}
                  <defs /> <title />{" "}
                  <path
                    fill="#d95d0b"
