        ...
        <>
            ...
            <VisibilityManager  itemScope itemType="http://schema.org/ImageObject" as="ul" classes={containerStyles.container}>    
                <VisibilityManager as="li" classes={`${styles.problem} shadow`} id="problem">
                    <Image itemProp="contentUrl" priority className={styles.problem__image} src={problem1} alt="Фото производства" />
                ...
                <VisibilityManager  itemScope itemType="http://schema.org/ImageObject" as="li" classes={`${styles.problem} shadow`}>
                    <Image itemProp="contentUrl"  priority className={styles.problem__image} src={problem2} alt="Изображение военного с косметическим протезом" />
                    <div className={styles.problem__content}>
                ...
                <VisibilityManager itemScope itemType="http://schema.org/ImageObject" as="li" classes={`${styles.problem} shadow`}>
                    <Image itemProp="contentUrl"  priority className={styles.problem__image} src={problem3} alt="Фото ремонта протеза" />
                    <div className={styles.problem__content}>
                ...
                <VisibilityManager  itemScope itemType="http://schema.org/ImageObject" as="li"  classes={`${styles.problem} shadow`}>
                    <Image itemProp="contentUrl"  priority className={styles.problem__image} src={problem4} alt="Фото реабилитации пациента" />
                    <div className={styles.problem__content}>
