...
export default () => {
  ...
  const metaConfig = {
    seoContent: `Инновационные решения в протезировании верхних конечностей

Виды протезов:
✓ Биоэлектрические системы управления
✓ Высокофункциональные механические модели
✓ Индивидуальные косметические решения

Особенности каждого типа:
• Технологические преимущества
• Функциональные возможности
• Индивидуальная адаптация
• Специализированные детские модели`,
