...
export default function AboutUsPage() {
  ...
  const metaConfig = {
    seoContent: `Модеста — это инновационная компания, занимающаяся протезированием.

Наши задачи:
✓ Разработка современных и доступных протезов
✓ Улучшение качества жизни пациентов
✓ Внедрение современных технологий в протезирование`,
