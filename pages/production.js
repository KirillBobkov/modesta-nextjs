...
#протезыРуки #бионическийДизайн #функциональныеПротезы #3DпечатьПротезы #индивидуальныеПротезы #медицинскиеТехнологии #долговечныеПротезы #современныйДизайн #реабилитационныеТехнологии #российскиеПротезы
   `,
    title: "Технологии производства протезов | Инновации Модеста",
    description: "Узнайте о передовых технологиях производства протезов Модеста. От проектирования до готового изделия - каждый этап создания протеза выполняется с максимальной точностью.",
    keywords: "производство протезов, технологии протезирования, 3d печать протезов, инновационные протезы, разработка протезов",
  };
  useScrollToLocation();
  return (
    <Layout
